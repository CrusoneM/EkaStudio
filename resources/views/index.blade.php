...
@section('content')
		...
		<section id="comofunciona">
			<div class="row">
				<div class="col m6" id="comofunciona-title">
					<h4>¿CÓMO<br>FUNCIONA?</h4>
				</div>
				<div class="col m6" id="comofunciona-info">
		...
		<section id="descuentos">
			...
			<div class="row">
				<div class="col m6" id="descuentos-title">
					<h5>¡¡ MIENTRAS MÁS GRANDE SEA TU PLAN...<br>...MAYOR SERÁ TU DESCUENTO !!</h5>
				</div>
				<div class="vertical-divider"></div>
				<div class="col m6" id="descuentos-descuentos">
